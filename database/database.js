module.exports = {
    ...
    updateRecord : function(user_id, access_token, refresh_token, instance_url) {
        ...
        var client = new pg.Client(conString);
        client.connect();
        var query = client.query("UPDATE loggin_data SET user_id = ($4), access_token = ($1), refresh_token = ($2), instance_url = ($3) WHERE user_id = ($4)", [access_token, refresh_token, instance_url, user_id]);
